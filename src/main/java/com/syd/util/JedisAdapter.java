...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] argv) {
        ...
        jedis.hsetnx(userKey, "name", "yxy");//若不存在，则设置此属性。
        ...
        jedis.srem(likeKey1, "5");//删除   remove
        print(27, jedis.smembers(likeKey1));
        jedis.smove(likeKey2, likeKey1, "25");
        print(28, jedis.smembers(likeKey1));
        print(29, jedis.scard(likeKey1));//查看集合有多少人
    ...
    public long sadd(String key, String value) {//封装方法
        Jedis jedis = null;
        try {
            jedis = pool.getResource();
            return jedis.sadd(key, value);//原生jar包的方法
        } catch (Exception e) {
    ...
    public long srem(String key, String value) {
        ...
        try {
            jedis = pool.getResource();
            return jedis.srem(key, value);//原生jar包的方法
        } catch (Exception e) {
            logger.error("发生异常" + e.getMessage());
        } finally {
            if (jedis != null) {
    ...
    public long scard(String key) {
        ...
        try {
            jedis = pool.getResource();
            return jedis.scard(key);//原生jar包的方法
        } catch (Exception e) {
            logger.error("发生异常" + e.getMessage());
        } finally {
            if (jedis != null) {
    ...
    public boolean sismember(String key, String value) {
        ...
        try {
            jedis = pool.getResource();
            return jedis.sismember(key, value);//原生jar包的方法
        } catch (Exception e) {
            logger.error("发生异常" + e.getMessage());
        } finally {
            if (jedis != null) {
    ...
    public List<String> brpop(int timeout, String key) {
        ...
        try {
            jedis = pool.getResource();
            return jedis.brpop(timeout, key);//原生jar包的方法
        } catch (Exception e) {
            logger.error("发生异常" + e.getMessage());
        } finally {
            if (jedis != null) {
    ...
    public long lpush(String key, String value) {
        ...
        try {
            jedis = pool.getResource();
            return jedis.lpush(key, value);//原生jar包的方法
        } catch (Exception e) {
            logger.error("发生异常" + e.getMessage());
        } finally {
            if (jedis != null) {
